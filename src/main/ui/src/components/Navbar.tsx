...
export function Navbar() {
  ...
  const links: { to: string; label: string; roles?: UserRole[]; dividerBefore?: boolean; end?: boolean }[] = [
    ...
    { to: '/volunteer/external-services', label: 'Внешние сервисы', roles: ['VOLUNTEER'] },
    ...
    { to: '/organizer/search-volunteers', label: 'Поиск волонтёров', roles: ['ORGANIZER'] },
    { to: '/organizer/external-services', label: 'Внешние сервисы', roles: ['ORGANIZER'] },
